...
public static partial class CopperLogger
{
    ...
    private static readonly string LogsPath = $"Logs/{CopperEngine.Core.CopperEngine.StartTime.ToShortDateString().Replace("/", "-")}/";
    private static readonly string LogsName = $"{CopperEngine.Core.CopperEngine.StartTime.ToLongTimeString().Replace(":", "-")}.txt";
